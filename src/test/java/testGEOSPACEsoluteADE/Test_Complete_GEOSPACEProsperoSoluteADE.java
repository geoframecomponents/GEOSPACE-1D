 ...
 */
public class Test_Complete_GEOSPACEProsperoSoluteADE {
	...
	public void Test() throws Exception {
		...
		String bottomBC = "Bottom Impervious";
        ...
        String outPathToLatentHeatSun			="output/4lys/LatentHeatSun_"+lab+"_"+lab2+".csv";
        String outPathToLatentHeatShadow		="output/4lys/LatentHeatShadow_"+lab+"_"+lab2+".csv";
        String outPathToSoilFluxEvaporation		="output/4lys/FluxEvaporation_"+lab+"_"+lab2+".csv";
        String outPathToFluxTranspiration		="output/4lys/FluxTranspiration_"+lab+"_"+lab2+".csv";
        String outPathToFluxEvapoTranspiration	="output/4lys/FluxEvapoTranspiration_"+lab+"_"+lab2+".csv";
        String outPathToTranspiration			="output/4lys/Transpiration_"+lab+"_"+lab2+".csv";
        String outPathToEvapoTranspiration		="output/4lys/EvapoTranspiration_"+lab+"_"+lab2+".csv";
        String outPathToSoilEvaporation 		="output/4lys/Evaporation_"+lab+"_"+lab2+".csv";
        
		String outPathToLeafTemperatureSun		="output/4lys/LeafTemperatureSun_"+lab+"_"+lab2+".csv";
		String outPathToLeafTemperatureShadow	="output/4lys/LeafTemperatureSh_"+lab+"_"+lab2+".csv";
		String outPathToSensibleSun				="output/4lys/sensibleSun_"+lab+"_"+lab2+".csv";
		String outPathToSensibleShadow			="output/4lys/sensibleShadow_"+lab+"_"+lab2+".csv";
        String outPathToRadiationSoil 			="output/4lys/RadiationSoil_"+lab+"_"+lab2+".csv";
		String outPathToRadiationSun			="output/4lys/RadSun_"+lab+"_"+lab2+".csv";
		String outPathToRadiationShadow			="output/4lys/RadShadow_"+lab+"_"+lab2+".csv";
		String outPathToCanopy					="output/4lys/Canopy_"+lab+"_"+lab2+".csv";
		String outPathToVPD						="output/4lys/VPD_"+lab+"_"+lab2+".csv";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		R1DSolver.seepageCoefficient = 0.0001;
		...
		JarvisStressFactor.useRadiationStress    = true;
		JarvisStressFactor.useTemperatureStress  = false;
		JarvisStressFactor.useVDPStress		   = true;	
		JarvisStressFactor.useWaterStress = true;
		JarvisStressFactor.defaultStress      = 1.0;
						
		JarvisStressFactor.alpha = 0.005;
		JarvisStressFactor.thetaR = 0.85;
		JarvisStressFactor.VPD0 = 5.0;
		JarvisStressFactor.Tl = 0;
		JarvisStressFactor.T0 = 17.0;
		JarvisStressFactor.Th = 38.0;
