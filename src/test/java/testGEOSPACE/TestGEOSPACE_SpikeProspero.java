 ...
 */
public class TestGEOSPACE_SpikeProspero {

	@Test
	public void Test() throws Exception {
		
		String startDate= "2018-05-22 13:00";
        String endDate	= "2018-05-22 14:00";
        String fId = "ID";
        String Id = "1";
        String site = "Cavone/";
		int timeStepMinutes = 60;
		String lab = "PR_waterstress"; ////richards - potential - waterstress -  environmentalstress - totalstress - potential_evaporation
		String lab2 = "0305_04";
		
		
		String pathTopBC    ="data/SpikeII/Prec_Irrig_Height_hourly.csv";
		String pathBottomBC ="data/SpikeII/SpikeII_0.csv";
		String pathGrid     ="data/Grid_NetCDF/Grid_SpikeII_2909_02_seepage7.nc";
		String pathSaveDates="data/SpikeII/saveSpikeII_hourly.csv"; 
		String pathOutput = "output/SpikeII/OMS_SpikeII"+lab+lab2+".nc";
		...
		DEMreader.file = "data/SpikeII/DemSpikeIIcut.tif";
		DEMreader.fileNovalue = -9999.0;
		DEMreader.geodataNovalue = Double.NaN;
		DEMreader.process();
		GridCoverage2D digitalElevationModel = DEMreader.outRaster;
		
		String inPathToTemperature 				="data/SpikeII/AirTemperature_hourly.csv";
        String inPathToWind 					="data/SpikeII/Wind_Speed_mean_hourly.csv";
        String inPathToRelativeHumidity 		="data/SpikeII/Rel_Hum_hourly.csv";
        String inPathToShortWaveRadiationDirect ="data/SpikeII/ShortwaveDirect_1_new.csv";
        String inPathToShortWaveRadiationDiffuse="data/SpikeII/ShortwaveDiffuse_1_new.csv";
        String inPathToLWRad 					="data/SpikeII/LongDownwelling_1.csv";
        String inPathToNetRad 					="data/SpikeII/Net_1.csv";
        String inPathToSoilHeatFlux 			="data/SpikeII/SpikeII_nan.csv";
        String inPathToPressure 				="data/SpikeII/SpikeII_nan.csv";
        String inPathToLai 						="data/SpikeII/SpikeII_LAI_6_2909.csv";
        String inPathToCentroids 				="data/SpikeII/centroid.shp";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		JarvisStressFactor.etaR  = -2.0; // depth of the root
		...
		InputBroker.representativeEsModel = "AverageWeightedMethod";  	//SizeWaterWeightedMethod, AverageWaterWeightedMethod //SizeWightedMethod, AverageWeightedMethod
		InputBroker.representativeTsModel = "RootWeightedMethod"; //SizeWaterWeightedMethod, AverageWaterWeightedMethod, RootWaterWeightedMethod //SizeWightedMethod, AverageWeightedMethod, RootWeightedMethod
